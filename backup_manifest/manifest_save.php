...
try {
    ...
    echo "<div class='alert alert-success'>success: Manifest <strong>".htmlspecialchars($manifest_no)."</strong> saved successfully.<br><a href='manifest_print.php?manifest_id=".intval($manifest_id)."' target='_blank' class='btn btn-default' style='margin-top:8px;padding:6px 12px;'>Print Manifest</a></div>";
} catch (Exception $ex) {
