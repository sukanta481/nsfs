...
(function($) {
  $.fn.simpleLoadMore = function( options ) {
    ...
    $loadMore.each(function(i, el) {
      ...
      if ( ! btnHTML ) btnHTML = '<div class="col-md-12 load-more text-center"><a href="javascript:void(0);" class="cnctBtn btnLink dark ' + cssClass + '__btn"><i><img src="assets/images/load.svg" alt="vwSer"></i>' + btnText + '</a></div>';
