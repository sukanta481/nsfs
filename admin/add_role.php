...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    if (empty($role_name)) {
        ...
        $check_role = mysqli_query($conn, "SELECT role_id FROM tbl_roles WHERE role_name='$role_name'");
        if (mysqli_num_rows($check_role) > 0) {
            ...
            if (mysqli_query($conn, $insert_role)) {
                ...
                if ($permission_success) {
                    header("Location: roles.php?success=Role created successfully with " . count($permissions) . " permissions");
                    exit;
                } else {
                    $error = "Role created but error assigning some permissions";
                }
            } else {
      ...
      <div class="right_col" role="main">
        <div class="role-form-container">
          ...
          <div class="form-header">
            <h2><i class="fas fa-shield-alt"></i> Create New Role</h2>
          ...
          <form method="POST" action="" id="roleForm">
            ...
            <div class="form-group">
              ...
              <textarea name="description" id="description" class="form-control" 
                        placeholder="Describe what this role can do..."><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
            </div>
