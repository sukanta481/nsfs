<?php
include_once(__DIR__ . "/includes/script/company_code.php"); // adjust path as needed
?>
...
<div class="x_panel">
    ...
    <div class="x_content">
        <?php if (!empty($companymsg)) echo $companymsg; ?>
        ...
        <form id="add_company_form" action="" method="post" name="add_company_form" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
            ...
            <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Company Email <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="email" name="company_email" value="" required="required" id="company_email" class="form-control col-md-7 col-xs-12" />
                </div>
            </div>
            <!-- Optional image upload (not shown here for simplicity) -->
