...
// Fix: avoid undefined keys for "actnhelper" and "helper_id"
$action    = isset($_REQUEST['actnhelper']) ? $_REQUEST['actnhelper'] : '';
$helper_id = isset($_REQUEST['helper_id']) ? $_REQUEST['helper_id'] : '';
