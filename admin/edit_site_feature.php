...
$sl = 'SELECT * FROM  tbl_site_feature WHERE feature_id = "'.$feature_id.'"';
                ...
                <div class="x_content">
                  ...
                  <form id="edit_feature_form" action="" method="post" name="edit_feature_form" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                      	<input type="text" name="feature_text" value="<?php echo stripcslashes(html_entity_decode($rc['feature_text']));?>"  id="feature_text" class="form-control col-md-7 col-xs-12"  />
                      </div>
                    </div>
                  	<!-- <div class="item form-group">
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-md-offset-3">
                      	...
                      	<input type="submit" name="edit_site_feature" value="Update" onclick="return validate_form('edit_feature_form');" class="btn btn-success btn-submit">
                      	<input type="button" name="edit_site_feature_cancel" value="Cancel" onclick="listsitefeature();" class="btn btn-success btn-submit">
                      </div>
                    </div>
                  </form>
