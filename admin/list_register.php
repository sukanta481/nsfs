    ...
    <div class="x_content">
        <table id="datatable-buttons" class="table table-striped table-bordered">
            ...
            while($result = mysqli_fetch_array($exe)) {
                // Fetch shipping info (may not exist!)
                ...
                // SAFETY: If shipping not found, use fallback array
                if (!$result1) {
                    $result1 = ['shipping_date' => '-', 'trip_no' => '-'];
                }

                // Get car number and driver name depending on rented_car
                if($result['rented_car']==1) {
                    ...
                    $car_number = $get_car_row && isset($get_car_row['car_number']) ? $get_car_row['car_number'] : '-';
                    ...
                    $driver_name = $get_driver_row && isset($get_driver_row['driver_name']) ? $get_driver_row['driver_name'] : '-';
                }
            ?>
