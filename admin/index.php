    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main" style="padding-top:0px !important;">
        ...
        <div class="dashboard-metric-grid">
          ...
          <!-- Manifest -->
          <a href="manifest.php?type=list_company&lp=ac&<?php echo session_name().'='.session_id();?>" class="metric-card metric-green metric-card-bold">
            <div class="metric-icon" style="background:#28a745;color:#fff;"><i class="fa fa-file-text"></i></div>
            <div>
              <div class="metric-label">Manifest</div>
              <div class="metric-value"><?= $manifest_count ?></div>
              <div class="metric-desc">Manifest Created</div>
            </div>
          </a>
          <!-- 7. Delayed -->
