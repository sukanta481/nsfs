...
<div class="x_panel">
 ...
 <input type="text" name="meta_keyword" id="meta_keyword" class="form-control col-md-7 col-xs-12" value="" required="required" />
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
 <textarea class="form-control col-md-7 col-xs-12" name="meta_desc"></textarea>
                      </div>
                    </div> -->
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
  <input type="text" name="package_type_name" id="package_type_name" value="" required="required" class="form-control col-md-7 col-xs-12"  />
                      </div>
                    </div>
		...
		?>
                  ...
                  <input type="hidden" name="package_type_id" value="" />
                      	
                      			
	
                      	
                      	<input type="submit" name="add_package_type" value="Save" onclick="return validate_form('edit_package_type_form');" class="btn btn-success btn-submit">
