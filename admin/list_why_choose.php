<script type="text/javascript">
	function delconfirmsitefeature(feature_id)
	{
		...
		if(c==true)
		{
		location.href='why_choose.php?type=list_why_choose&lp=ac&feature_id='+feature_id+'&actnwhychoose=dellwhychoose';
		//return true;
		}
		else
		{
...
$sql = "select * from tbl_why_choose order by feature_id asc";
...
<td>					
	 ...
	 <a class="btn btn-info btn-xs" href="why_choose.php?type=edit_why_choose&lp=ac&feature_id=<?php print $result['feature_id']; ?>&<?php echo session_name().'='.session_id();?>">Edit</a>	
