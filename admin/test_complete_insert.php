...
echo "Testing COMPLETE INSERT query with service_type...\n\n";
...
$query = "INSERT INTO tbl_shipping_details (
    trip_group_id, doc_no, doc_type, service_type, branch_office, register_id, shipping_id, 
    ...
    '$trip_group_id', 'TEST001', '', 'Express', '', 0, 0, 
