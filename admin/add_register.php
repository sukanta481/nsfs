  ...
  <div class="x_content">
    <form id="add_register_form" action="includes/script/register_code.php" method="post" autocomplete="off" class="form-horizontal form-label-left">
      ...
      <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="number" name="car_oil_amount" id="car_oil_amount" value="0" class="form-control" min="0">
        </div>
      </div>
      <div class="item form-group">
      ...
      <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="time" name="car_out_time" id="car_out_time" class="form-control">
        </div>
      </div>
      <div class="item form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">Doc No <span class="required">*</span></label>
        <div class="col-md-6 col-sm-6 col-xs-12">
      ...
      <div class="item form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">Pay To <span class="required">*</span></label>
        <div class="col-md-6 col-sm-6 col-xs-12">
